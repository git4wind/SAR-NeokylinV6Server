...
cp /usr/local/hbserver/lib/*.so /usr/lib/
...
mv /usr/local/hbserver/pam_hbla.so /lib/security/
...
touch /usr/local/hbserver/service_status
touch /usr/local/hbserver/iptables_status
